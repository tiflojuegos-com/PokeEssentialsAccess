...
**Era GameData** (Essentials v18 en adelante): Pokémon Añil, Pokémon Royal, Pokémon Relict, Pokémon Infinite Fusion, Pokémon Infinite Fusion 2 Hoenn.
...
Si vas a tocar el código, empieza por **[docs/08_RUBY_FUNDAMENTALS.md](docs/08_RUBY_FUNDAMENTALS.md)**: el mod corre en parte sobre Ruby 1.8.7 y eso limita qué sintaxis puedes escribir.
