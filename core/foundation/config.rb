module PokeAccess
  ...
  module Config
    SCHEMA = [
      ...
      [:audio3d_mark,        85,    :vol,  :audio3d_vol, :lbl_pos_marks,       :help_pos_marks],
      ...
      [:audio3d_freq_npc,    90,    :vol,  :audio3d_freq, :lbl_freq_people,    :help_freq_people],
      ...
      [:audio3d_freq_mark,   80,    :vol,  :audio3d_freq, :lbl_freq_marks,     :help_freq_marks],
      [:guide_freq,          75,    :vol,  :audio3d_freq, :lbl_guide_freq,     :help_guide_freq],
      ...
      [:audio3d_tone_mark,       50, :tone, :audio3d_tone, :lbl_tone_marks,      :help_tone_marks],
